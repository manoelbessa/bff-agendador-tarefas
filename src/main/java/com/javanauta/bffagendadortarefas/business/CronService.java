...
public class CronService {
    ...
    public void buscaTarefasProximaHora() {
        ...
        LocalDateTime horaFuturo = LocalDateTime.now().plusHours(1);
        LocalDateTime horaFuturaMaisCinco = LocalDateTime.now().plusHours(2);

        List<TarefasDTOResponse> listaTarefas = tarefasService.buscaTarefasAgendadasPorPeriodo(horaFuturo, horaFuturaMaisCinco, token);
